...
#define	GPIO_MUX_DIR_INPUT			0x0
#define	GPIO_MUX_DIR_OUTPUT			0x1
#define	GPIO_MUX_DIR_INT			0xF
...
#define	EXT_INT_TRIG_FALLING_EDGE	0x2
#define	EXT_INT_TRIG_RISING_EDGE	0x3
#define	EXT_INT_TRIG_BOTH_EDGE		0x4

#define	EXT_INT43_MASK_ADDR			(GPX3_BASE + EXT_INT43_MASK_OFFSET)
#define	EXT_INT_MASK_ENABLE			0
#define	EXT_INT_MASK_DISABLE		1
